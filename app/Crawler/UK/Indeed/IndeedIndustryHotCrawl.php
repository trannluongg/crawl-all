...
namespace App\Crawler\UK\Indeed;
...
class IndeedIndustryHotCrawl extends CrawlerBase
{
    private $params;
    ...
    {
        return [
            'selector' => 'css: #categories li',
            'link'     => false,
            'multiple' => true,
            'child'    => [
                'heading' => [
                    'selector' => 'css: a.text_level_3',
                    'link'     => false,
                    'multiple' => false
                ],
            ]
     ...
     * Date: 23/05/2022
     */
    public function run($url, $id): bool
    {
